...
namespace OpenCVTemplateUI {
	...
	/// </summary>
	public ref class LaplacianFreq : public System::Windows::Forms::Form
	{
	public:
		LaplacianFreq(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button2->Click += gcnew System::EventHandler(this, &LaplacianFreq::button2_Click);
			// 
			// label9
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &LaplacianFreq::button1_Click);
			// 
			// pictureBox2
			// 
			...
			this->Name = L"LaplacianFreq";
			this->Text = L"LaplacianFreq";
...
#pragma endregion
	private: System::Void button2_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		img = imread("images/Fig0458(a)(blurry_moon).tif");
		if (img.data)
		{
			im.setMat(img);
