...
namespace OpenCVTemplateUI {
	...
	/// </summary>
	public ref class LowPassFilter : public System::Windows::Forms::Form
	{
	public:
		LowPassFilter(void)
		{
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->button2->Click += gcnew System::EventHandler(this, &LowPassFilter::button2_Click);
			// 
			// label9
			// 
			...
			this->label9->Click += gcnew System::EventHandler(this, &LowPassFilter::label9_Click);
			// 
			// label8
			// 
			...
			this->button1->Click += gcnew System::EventHandler(this, &LowPassFilter::button1_Click);
			// 
			// pictureBox1
			// 
			...
			this->trackBar1->Scroll += gcnew System::EventHandler(this, &LowPassFilter::trackBar1_Scroll);
			// 
			// label7
			// 
			...
			this->label3->Text = L"LowPassFilter";
			// 
			// label4
			// 
			...
			this->Name = L"LowPassFilter";
			this->Text = L"LowPassFilter";
...
#pragma endregion
	...
	private: System::Void button1_Click(System::Object^  sender, System::EventArgs^  e) {
		...
		{
			im.setMat(img);
			im.setMat(im.LowHighPassFilter(1,trackBarRange(trackBar1->Value)));
			im.DrawCvImageColor(pictureBox2);

			im.setMat(img);
			im.setMat(im.LowHighPassFilter(2, trackBarRange(trackBar1->Value)));
			im.DrawCvImageColor(pictureBox3);

			im.setMat(img);
			im.setMat(im.LowHighPassFilter(3, trackBarRange(trackBar1->Value)));
